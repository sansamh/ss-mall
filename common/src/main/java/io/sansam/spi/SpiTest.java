...
//        String comapny = "yd1";
//
//        ServiceLoader<Delivery> serviceLoader = ServiceLoader.load(Delivery.class);
//        Iterator<Delivery> iterator = serviceLoader.iterator();
//
//        Delivery delivery;
//        while (iterator.hasNext()) {
//            delivery = iterator.next();
//            if (delivery.match(comapny)) {
